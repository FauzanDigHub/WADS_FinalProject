          ...
          <div class="header-content mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <form class="text-center" style="color: #757575;" method="post" id="formImgInp" action="save/{{$post -> post_id}}" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        ...
                        <div class="md-form mt-3">
                            <input required name="name" value="{{ $post->name }}" type="name" id="materialSubscriptionFormPasswords" class="form-control">
                            <label for="materialSubscriptionFormPasswords">Full Name</label>
                        </div>

                        <!-- Title -->
                        <div class="md-form">
                            <input required name="title" value="{{ $post->post_title }}" type="title" id="materialSubscriptionFormEmail" class="form-control">
                            <label for="materialSubscriptionFormEmail">Title</label>
                        </div>
                        <!-- Tag -->
                        <select required name="major" value="{{ $post->cat_id }}" class="custom-select">
                        ...
                        <div class="file-field">
                            <div class="btn btn-rounded purple-gradient btn-sm float-left">
                                ...
                                <input required accept="image/*" value="{{ $post->img_url}}" id="upload" type="file" name="image" onchange="readURL(this);" class="form-control">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea required name="text" value="{{ $post->post_description }}" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
              ...
              <div class="device">
                <div class="screen">
                  ...
                  <div class="d-none d-xl-block">
                    <img src="{{ asset('img/LogoHome.png')}}" class="img-fluid" alt="">
                  </div>  
                </div>
                <div class="button">
